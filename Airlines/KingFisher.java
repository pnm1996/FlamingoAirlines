...
String name[]=new String[100];
    ...
    void kingFisherMenu() throws IOException
    {        
        System.out.println("\f");
        
        
        int ch=0,ch1=0,i;
        String departure[]={"Mumbai","Chennai","New Delhi"};
        String arrival[]={"Ahmedabad","Bangalore","Kolkata"};
        double rate[][]={
                            {3000,4000,6000},
                            {4000,3000,8000},
                            {3500,5500,4000}              
        ...
        System.out.println("*** KINGFISHER AIRLINES  ***");
         delay();
        System.out.println("    =======    =======    \n"); 
        delay();
